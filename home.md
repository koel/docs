...
If you're syncing compilation albums (albums with multiple songs from different artists) make sure the "Album Artist" tag is set, otherwise each song will end up in its own album. Some ripping software sets this automatically; make sure yours does.
